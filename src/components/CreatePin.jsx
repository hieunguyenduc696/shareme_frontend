...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if ( type === 'image/png' || type === 'image/jpg' || type === 'image/gif' || type === 'image/svg' || type === 'image/jpeg') {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5 flex-wrap">
      {fields && (
